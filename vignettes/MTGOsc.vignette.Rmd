...
For this tutorial we'll focus on Urothelium, which is of intermediate size. We create two "selector" arrays, one for cells and one for genes.
...
edges = write.edges(coexpression = coexp, outfolder = root, keep.weights = FALSE)
